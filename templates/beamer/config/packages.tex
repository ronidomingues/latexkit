...
\definecolor{lkPrimary}{RGB}{16, 58, 110}    % azul institucional
\definecolor{lkAccent}{RGB}{198, 132, 24}    % destaque
\definecolor{lkInk}{RGB}{34, 34, 34}         % texto

\setbeamercolor{normal text}{fg=lkInk}
\setbeamercolor{structure}{fg=lkPrimary}
\setbeamercolor{title}{fg=lkPrimary}
\setbeamercolor{frametitle}{fg=lkPrimary}
\setbeamercolor{alerted text}{fg=lkAccent}
\setbeamercolor{block title}{bg=lkPrimary!12, fg=lkPrimary}
\setbeamercolor{block body}{bg=lkPrimary!5}
\setbeamercolor{itemize item}{fg=lkAccent}
\setbeamercolor{itemize subitem}{fg=lkAccent}
...
\setbeamercolor{author in head/foot}{fg=lkInk!60}
\setbeamercolor{title in head/foot}{fg=lkInk!60}
\setbeamercolor{date in head/foot}{fg=lkInk!60}
...
\newcommand{\fonte}[1]{%
  \par\vspace{0.3em}{\scriptsize\color{lkInk!70}Fonte: #1}%
}
